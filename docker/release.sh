...
docker tag "cleanspeak/cleanspeak-management-interface:latest" "cleanspeak/cleanspeak-management-interface:$VERSION}"
...
docker tag "cleanspeak/cleanspeak-webservice:latest" "cleanspeak/cleanspeak-webservice:$VERSION}"
